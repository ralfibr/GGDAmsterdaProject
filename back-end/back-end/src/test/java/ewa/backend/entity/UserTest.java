...
class UserTest {
    ...
    @Test
    void checkValidateEncodedPassword(){
        User user = new User(1, "Mark", "van Manen", "mark.van.manen@hva.nl", "d9b5f58f0b38198293971865a14074f59eba3e82595becbe86ae51f1d9f1f65e", "0612345678", "Admin", "Amstel", "020 394 2834");
        boolean expectedResult = true;
        boolean realResult = user.validateEncodedPassword("d9b5f58f0b38198293971865a14074f59eba3e82595becbe86ae51f1d9f1f65e");
        assertEquals(expectedResult, realResult);
    }
